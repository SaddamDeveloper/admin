...
<head>
      ...
      <title>Fooover Eat - Online Food Ordering</title>
      <!-- Favicon Icon -->
      <link rel="icon" type="image/png" href="https://askbootstrap.com/preview/osahan-eat/img/favicon.png">
      <!-- Bootstrap core CSS-->
      <link href="https://askbootstrap.com/preview/osahan-eat/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      <!-- Font Awesome-->
      <link href="https://askbootstrap.com/preview/osahan-eat/vendor/fontawesome/css/all.min.css" rel="stylesheet">
      <!-- Font Awesome-->
      <link href="https://askbootstrap.com/preview/osahan-eat/vendor/icofont/icofont.min.css" rel="stylesheet">
      <!-- Select2 CSS-->
      <link href="https://askbootstrap.com/preview/osahan-eat/vendor/select2/css/select2.min.css" rel="stylesheet">
      <!-- Custom styles for this template-->
      <link href="https://askbootstrap.com/preview/osahan-eat/css/osahan.css" rel="stylesheet">
      <!-- Owl Carousel -->
      <link rel="stylesheet" href="https://askbootstrap.com/preview/osahan-eat/vendor/owl-carousel/owl.carousel.css">
      <link rel="stylesheet" href="https://askbootstrap.com/preview/osahan-eat/vendor/owl-carousel/owl.theme.css">
   </head>
   <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-light osahan-nav shadow-sm">
         <div class="container">
            <a class="navbar-brand" href="index.html"><img alt="logo" src="https://fooover.com/img/logo-fooover.png" width="140px"></a>
               ...
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/listing.html">Listing</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/detail.html">Detail + Cart</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/checkout.html">Checkout</a>
                     </div>
                  </li>
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        ...
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/login.html">Login</a>
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <img alt="Generic placeholder image" src="https://askbootstrap.com/preview/osahan-eat/img/user/4.png" class="nav-osahan-pic rounded-pill"> My Account
                     </a>
                     <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/orders.html#orders"><i class="icofont-food-cart"></i> Orders</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/orders.html#offers"><i class="icofont-sale-discount"></i> Offers</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/orders.html#favourites"><i class="icofont-heart"></i> Favourites</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/orders.html#payments"><i class="icofont-credit-card"></i> Payments</a>
                        <a class="dropdown-item" href="https://askbootstrap.com/preview/osahan-eat/orders.html#addresses"><i class="icofont-location-pin"></i> Addresses</a>
                     </div>
                  </li>
            ...
            <div class="row d-flex align-items-center">
               <div class="col-md-8">
                  <div class="homepage-search-title">
                     <h1 class="mb-2 font-weight-normal"><span class="font-weight-bold">Find Awesome Deals</span> in India</h1>
                     <h5 class="mb-5 text-secondary font-weight-normal">Lists of top restaurants, cafes, pubs, and bars in Assam, based on trends</h5>
                  </div>
                     ...
                     <form class="form-noborder">
                        <div class="form-row">
                           ...
                           <div class="col-lg-2 col-md-2 col-sm-12 form-group">
                              <a href="https://askbootstrap.com/preview/osahan-eat/listing.html" class="btn btn-primary btn-block btn-lg btn-gradient">Search</a>
                  ...
                  <div class="owl-carousel owl-carousel-category owl-theme">
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/2.png" alt="">
                              <h6>Pizza</h6>
                              <p>120</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/3.png" alt="">
                              <h6>Healthy</h6>
                              <p>130</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/4.png" alt="">
                              <h6>Vegetarian</h6>
                              <p>120</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/5.png" alt="">
                              <h6>Chinese</h6>
                              <p>111</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/6.png" alt="">
                              <h6>Hamburgers</h6>
                              <p>958</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/7.png" alt="">
                              <h6>Dessert</h6>
                              <p>56</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/8.png" alt="">
                              <h6>Chicken</h6>
                              <p>40</p>
                           </a>
                        </div>
                     ...
                     <div class="item">
                        <div class="osahan-category-item">
                           <a href="#">
                              <img class="img-fluid" src="https://askbootstrap.com/preview/osahan-eat/img/list/9.png" alt="">
                              <h6>Indian</h6>
                              <p>156</p>
                           </a>
                        </div>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-sm-12 text-center">
                  <a href="https://askbootstrap.com/preview/osahan-eat/register.html" class="btn btn-success btn-lg">
      ...
      <!-- Owl Carousel -->
      <script src="https://askbootstrap.com/preview/osahan-eat/vendor/owl-carousel/owl.carousel.js"></script>
